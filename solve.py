...
# move stores (x,y,side) i.e number of missionaries, cannibals to be moved from left to right or right to be left for paritcular state
...
class Solution():
    ...
    def __init__(self):
        ...
        self.graph = pydot.Dot(graph_type='graph', strict=False, bgcolor="#fff3af", label="fig:Missionaries and Cannibal State Space Tree", fontcolor="red", fontsize="24")
        self.visited = {}
        self.solved = False
    ...
    def draw_legend(self):
        ...
        """
        graphlegend = pydot.Cluster(graph_name = "legend", label = "Legend", fontsize="20", color="gold", fontcolor = "blue", style="filled", fillcolor="#f4f4f4")
        ...
        node2 = pydot.Node("2", style="filled", fillcolor="red", label="Killed Node", fontcolor = "white",width="2", fixedsize="true")
            ...
            for x, y in self.options:
                ...
                if  (next_m, next_c, next_s) not in self.visited: 
                    if self.is_valid_move(next_m, next_c):
                        ...
                        #keep track of parent and correspoding move
